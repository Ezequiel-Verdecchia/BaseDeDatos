...
{
    public partial class alta_productos : System.Web.UI.Page
    {
        ...
        {
            {
                string consulta = @"INSERT INTO productos (producto,descripcion,stock,PU)
                            VALUES (@TB1,@TB2,@TB3,@TB4)";
                string consultaValidar = @"SELECT * FROM productos WHERE producto LIKE @TB1";
                ...
                try
                {
                    ...
                    else
                    {
                        try
                        {
                            ...
                            command.Parameters.AddWithValue("TB4", TextBox4.Text);
                            conn.Open();
